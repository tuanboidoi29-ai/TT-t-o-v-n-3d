...
module TranTuanNoiThat
  ...
  class << self
    ...
    def install_door_standard_ui
      ...
      @cabinet_door_cmd.status_bar_text = 'P1-P2 chéo trên Face bất kỳ · không khóa trục · TÂM chia tự do · / chia · 2/3/4 chia nhanh · SHIFT Dọc/Ngang · CTRL Lọt/Phủ · ENTER tạo · TAB cài đặt.'
