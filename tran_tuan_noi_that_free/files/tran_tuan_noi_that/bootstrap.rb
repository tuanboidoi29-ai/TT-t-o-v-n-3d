  ...
  class << self
    ...
    def install_door_standard_ui
      ...
      @cabinet_door_cmd ||= command(
        'Tạo Cánh Chuẩn',
        'door_standard.svg',
        'P1-P2 chéo tự do · TÂM động theo chuột · / chia tự do · 2/3/4 chia nhanh · SHIFT Dọc/Ngang · CTRL Lọt/Phủ · ENTER tạo · TAB cài đặt'
      ...
      @cabinet_door_cmd.status_bar_text = 'P1-P2 chéo trên mặt đứng · không khóa trục · TÂM động theo chuột · / chia tự do · 2/3/4 chia nhanh · SHIFT Dọc/Ngang · CTRL Lọt/Phủ · ENTER tạo · TAB cài đặt.'
