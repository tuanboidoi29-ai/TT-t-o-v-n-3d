...
assert(calls.at(-1)[2].cut_mm===20 && calls.at(-1)[2].scope==='selected' && calls.at(-1)[2].detail_dims===true && calls.at(-1)[2].xray_views.length===7,'new options sent through action buttons');
