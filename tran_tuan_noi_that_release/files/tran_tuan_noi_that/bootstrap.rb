...
module TranTuanNoiThat
  ...
  class << self
    ...
    def reload_runtime
      # License V1.0.2 -> Payment V1.1.0 -> Owner Admin V1.2.0 -> UI hotfix V1.2.1 -> JS hotfix V1.2.2.
    ...
    def install_license_ui
      ...
      @license_cmd ||= command(
        'Bản Quyền',
        'license.svg',
        'Mã máy · mua từng chức năng · máy OWNER có quyền quản lý khách, giá, thanh toán và quyền.'
      ) { License.show_dialog }
